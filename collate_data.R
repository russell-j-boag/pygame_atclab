...
# Save master CSV
write_csv(dat, "data/data_atc_all.csv")
...
# Save master CSV
write_csv(dat, "data/data_atc.csv")
...
# Save master CSV
write_csv(dat, "data/data_atc_postblock_all.csv")
...
# Save master CSV
write_csv(dat, "data/data_atc_sliders_all.csv")
